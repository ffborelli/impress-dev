var app = angular.module('contextcount', [ 'ngResource', 'ui.bootstrap', 'impressApp' ]);

// Create a controller with name placesListController to bind to the grid
// section.
app.controller('contextCountController', function($scope, $rootScope,$http, contextCountService) {

...
public class ResourceLogDAO extends GenericDAO<ResourceLog> implements Serializable {
	...
	public Integer countResourceLogs() {
		...
		// CriteriaBuilder builder = getEntityManager().getCriteriaBuilder();
		CriteriaQuery<ResourceLog> cQuery = getCriteriaBuilder().createQuery(
				ResourceLog.class);
		...
		countQuery.select(getCriteriaBuilder().count(
				countQuery.from(ResourceLog.class)));
	...
	public List<ResourceLog> findResourceLogs(int startPosition, int maxResults,
		...
		CriteriaQuery<ResourceLog> cQuery = getCriteriaBuilder().createQuery(
				ResourceLog.class);
		Root<ResourceLog> from = cQuery.from(ResourceLog.class);
		CriteriaQuery<ResourceLog> select = cQuery.select(from);
		...
		TypedQuery<ResourceLog> listQuery = getEntityManager()
				.createQuery(select);
	...
	public List<ResourceLog> findResourceLogsSearch(int startPosition,
	...
	private ArrayList<Predicate> createPredicate(Root<ResourceLog> from,
			String search) {

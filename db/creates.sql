...
CREATE TABLE fusion_log(
	...
	fusion_value_log text NOT NULL, /* value para log_fusion_value */
...
CREATE TABLE resource(
	...
	CONSTRAINT dependence_fusion_log_fk FOREIGN KEY (dependence_fusion_log_fk) REFERENCES fusion_log(id_fusion_log)
);
...
CREATE TABLE schedule(
	...
	description text NOT NULL,
        id_rule_fk int,
        CONSTRAINT id_rule_fk FOREIGN KEY (id_rule_fk) REFERENCES rule(id_rule),
        initial timestamp NOT NULL,
        final timestamp NOT NULL,
        priority_time text NOT NULL,
        recurrence text NOT NULL,
        status text NOT NULL
);

CREATE TABLE schedule_log(
	id_schedule_log serial NOT NULL PRIMARY KEY,
	id_schedule_fk int,
        CONSTRAINT id_schedule_fk FOREIGN KEY (id_schedule_fk) REFERENCES schedule(id_schedule),
        creation_date timestamp NOT NULL
);


CREATE TABLE resource_schedule(
	id_resource_schedule serial NOT NULL PRIMARY KEY,
	id_resource_fk int,
        CONSTRAINT id_resource_fk FOREIGN KEY (id_resource_fk) REFERENCES resource(id_resource),
        id_schedule_fk int,
        CONSTRAINT id_schedule_fk FOREIGN KEY (id_schedule_fk) REFERENCES schedule(id_schedule)

...
public class PresenceListener4 implements UpdateListener {
	...
	public void update(EventBean[] newData, EventBean[] oldData) {
		...
		System.out.println("Ultrasonic 4 " + count);
				
		Resource r = this.getResourceFacade().find(4);
		...
		if (c.getRunning() == 2) {
			...
			ResourceLog kinect = this.getResourceLogFacade().getLastByResource(15);
			...
			Resource newResource = this.getResourceFacade().find(19);

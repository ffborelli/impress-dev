...
import br.ufabc.impress.drools.PublishDrools;
import br.ufabc.impress.mqtt.*;

public class MqttPublish implements MqttCallback, Runnable {
	//private String uri;
	//private String clientId;
	//private String topic;
	//private String messageSend;
	private String name;
	private BlockingQueue<MqttPublishModel> queue;
	
	private long threadId;

//	public MqttPublish(String uri, String clientId, String topic,
//			String messageSend) {
...
//	}
	...
	public MqttPublish(String name, BlockingQueue<MqttPublishModel> queue) {
		this.name = name;
		this.queue = queue;
	}
	...
	public void run() {
		...
		while (true) {
			if (queue.isEmpty() == false) {
				try {
					MqttPublishModel model =  queue.take();
					System.out.println("Running " + name + " - " + model.getMessageSend());
					
					this.publish(model.getUri(), model.getClientId(), model.getTopic(), model.getMessageSend());
	...
	private void publish(String uri, String clientId, String topic,
			String messageSend) {
...
//		}
	...
	public void messageArrived(String topic, MqttMessage message)
			throws Exception {
		String time = new Timestamp(System.currentTimeMillis()).toString();
		System.out.println("Publish -- Time:\t" + time + "  Topic:\t" + topic

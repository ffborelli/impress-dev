...
//	private static ArrayList<String> buffer = new ArrayList<String>();
	...
	public boolean requestRepository(Object o, String message) {
		...
		try {
			...
			String UID = EvalUtil.getParameter("UID", message, ";", "=");
			
			String p4 = EvalUtil.getParameter("P4", message, ";", "=");
			String p5 = EvalUtil.getParameter("P5", message, ";", "=");
			...
			eval.setP4(new Timestamp(Long.valueOf(p4)));
			eval.setP5(new Timestamp(Long.valueOf(p5)));

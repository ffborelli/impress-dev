...
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(6,'60%','14/10/29 12:35:44');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(3,'23.4','14/10/29 12:35:47');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(6,'55%','14/10/29 12:35:54');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(3,'22.9','14/10/29 12:35:57');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(4,'Off','14/10/29 12:36:54');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(5,'Off','14/10/29 12:37:47');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(1,'On','14/10/29 12:46:47');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(2,'On','14/10/29 12:46:57');
...
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'23.15','14/10/29 12:55:47');
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'57.5','14/10/29 12:56:54');
...
insert into context(context_name, id_place_fk, id_context_type_fk, id_context_fk,enable_0_disable_1,context_sequence,context_count,context_registered) values('Hot R808 Classroom',4,1,1,0, '3;1;1;1-2;',2,1);

insert into context(context_name, id_place_fk, id_context_type_fk, id_context_fk,enable_0_disable_1,context_sequence,context_count,context_registered) values('Clearly R300 Classroom',6,3,2,0,'6;1;2;4-5;',0,1);

--insert into context_count(context_sequence,context_count,context_registered) values('3;1;1;1-2;',2,1);
--insert into context_count(context_sequence,context_count,context_registered) values('6;1;2;4-5;',0,1);
--insert into context_count(context_sequence,context_count,context_registered) values('7;1;3;8-9',10,0);
...
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','14/10/29 12:35:58');
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'52,5%','14/10/29 12:35:59');
...
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(7,'60%','14/10/29 12:35:44');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(8,'50%','14/10/29 12:35:54');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(9,'50%','14/10/29 12:35:56');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(12,'55%','14/10/29 12:35:57');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(10,'On','14/10/29 12:45:44');
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(11,'On','14/10/29 12:46:44');
...
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/10/29 12:38:58'); 
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/10/29 12:39:59'); 
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/10/29 12:40:59'); 

insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/11/29 12:38:58'); 
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/11/29 12:39:59'); 
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/11/29 12:40:59'); 
insert into fusion_log(id_fusion_fk, fusion_log_value, creation_date) values(1,'55%','15/11/29 12:41:59'); 
...
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(15,'60%','15/10/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(16,'50%','15/10/29 12:35:54'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(17,'60%','15/10/29 12:35:56'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(18,'50%','15/10/29 12:35:57'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(19,'55%','15/10/29 12:35:56'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(20,'55%','15/10/29 12:35:57'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(13,'Decrease','15/10/29 12:45:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(14,'Decrease','15/10/29 12:46:44'); 

insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(29,'60%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(21,'50%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(22,'55%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(23,'60%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(24,'50%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(25,'55%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(26,'55%','15/11/29 12:35:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(27,'Decrease','15/11/29 12:45:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(28,'Decrease','15/11/29 12:46:44'); 
insert into resource_log(id_resource_fk, resource_log_value, creation_date) values(30,'55%','15/11/29 12:55:44');      

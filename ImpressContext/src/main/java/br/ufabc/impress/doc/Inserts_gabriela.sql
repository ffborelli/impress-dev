...
insert into context(context_sequence,context_name, id_place_fk, id_context_type_fk, id_context_fk,enable_0_disable_1) values('1*1','Hot R808 Classroom',4,1,1,0);
insert into context(context_sequence,context_name, id_place_fk, id_context_type_fk, id_context_fk,enable_0_disable_1) values('1*1','Clearly R300 Classroom',6,3,2,0);

...
import br.ufabc.impress.dao.ResourceFusionLogDAO;
...
public class ResourceFusionLogFacade implements Serializable{
	...
	public List<ResourceFusionLog> getByFusionLog(List<FusionLog> list) {
		resourceFusionLogDAO.beginTransaction();
		List<ResourceFusionLog> result = resourceFusionLogDAO.getByFusionLog(list);
		resourceFusionLogDAO.closeTransaction();
		return result;
	}
	...
	public List<ResourceFusionLog> getByFusionLog(FusionLog fusionLog) {
		resourceFusionLogDAO.beginTransaction();
		List<ResourceFusionLog> result = resourceFusionLogDAO.getByFusionLog(fusionLog);
		resourceFusionLogDAO.closeTransaction();
		return result;
	}

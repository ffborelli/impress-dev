...
public class PresenceListener1 implements UpdateListener {
	...
	public void update(EventBean[] newData, EventBean[] oldData) {
		...
		System.out.println("Ultrasonic 1 " + count);
				
		Resource r = this.getResourceFacade().find(1);
		...
		if (c.getRunning() == 2) {
			...
			Resource newResource = this.getResourceFacade().find(16);

...
public class PresenceListener3 implements UpdateListener {
	...
	public void update(EventBean[] newData, EventBean[] oldData) {
		...
		System.out.println("Ultrasonic 3 " + count);
				
		Resource r = this.getResourceFacade().find(3);
		...
		if (c.getRunning() == 2) {
			...
			Resource newResource = this.getResourceFacade().find(18);

...
public class MqttSubscribe2 implements MqttCallback{
	...
	public MqttSubscribe2(String uri, String clientId, String topic) {
	...
	public void subscribe(String uri, String clientId, String topic) {
...
//		demoUtil.saveLog("Subscribing topic " + topic);
	...
	public void connectionLost(Throwable msg) {
		System.out.println("Connection Lost " + clientId + " "+ msg.getStackTrace().toString() + " " + msg.getLocalizedMessage() + msg.getCause());
